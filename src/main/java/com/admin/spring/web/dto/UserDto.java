...
import com.admin.spring.customAnnotations.PasswordMatches;
import com.admin.spring.customAnnotations.ValidEmail;
...
public class UserDto {
    ...
    @NotBlank (message = "As senhas precisam ser iguais")
